...
function loadAnalytics() {
    ...
    // FIX: call /students/register/{registerNumber} with auth header

    fetch(`${API_URL}/students/register/${registerNumber}`, {
...
function loadLeetCode(username) {
    ...
    fetch(`${API_URL}/leetcode/${username}`, {
...
function loadCodeChef(username) {
    ...
    fetch(`${API_URL}/codechef/${username}`, {
...
function loadCodeforces(username) {
    ...
    fetch(`${API_URL}/codeforces/${username}`, {
